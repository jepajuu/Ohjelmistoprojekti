...
class GameManager:
    ...
    def start_game(self):
        ...
        # Asetetaan vuoro ensimmäiselle lisätylle pelaajalle
    ...
    def process_shot(self, shooter_id, x, y):
        ...
        if shooter_id != self.game.current_turn:
            return {"error": "Ei ole sinun vuorosi"}
        
        # Lisää logiikka osumien tarkistukseen jne.
        return {"x": x, "y": y, "hit": True}  # Esimerkkiarvo
